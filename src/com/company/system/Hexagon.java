...
public class Hexagon extends Polygon {
	...
	private void addPoints() {
		...
		for (int i = 0; i < 6; i++) {
			...
			double nextX = this.hexWidth * cos(PI / 180 * radAngle);
			double nextY = this.hexWidth * sin(PI / 180 * radAngle);

			this.addPoint((int) (this.center.getX() + nextX), (int) (this.center.getY() + nextY));
		}
	}
